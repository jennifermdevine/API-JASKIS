...
used 'create collection' and created jaskis w/a collection named bounties
used commands:
...
this one I struggled with a lot - tried:

db.bounties.find({reward: 0})
db.bounties.find({reward: "0"})
db.bounties.find({}, {reward: "0"})
...
struggled with this one as well. tried:
